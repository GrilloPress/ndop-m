(function (global) {
  ...
  var SelectionButtons = function (elmsOrSelector, opts) {
    ...
    this.radioClass = 'multiple-choice--radio';
    this.checkboxClass = 'multiple-choice--checkbox';
    if (opts !== undefined) {
...
$(document).ready(function() {
  ...
  var $blockLabels = $(".form-label input[type='radio'], .form-label input[type='checkbox']");
